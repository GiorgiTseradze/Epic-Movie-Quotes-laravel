...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body stlye="font-family:'inter'; width:full; height:full; ">
        <div style="width: 100%; height: 100%; background-color: #181624; color:white; padding-top: 2rem; padding-bottom: 2rem;">
            ...
            <div style="margin-left: 3%; width: 80%; height:10%">
                <div style="background-color: #E31221; width: 5.5rem; height:1.2rem; border-radius: 25px;">
                    <a style="margin-left: 1.6rem; padding: 0 0.5 0 0.5rem; text-decoration:none; color:white;" 
                    href="{{config('app.FRONT_DOMAIN').'new-email-confirm?verify_user_token='.$email->token.'&email='.$email->email}}">
                    Verify</a>
            </div>
            </div>
            ...
            <div style="margin-left: 3%; width: 80%; height: 20%; color:#DDCCAA;">
                <p style="word-wrap: break-word;">
                    {{config('app.FRONT_DOMAIN').'new-email-confirm?verify_user_token='.$email->token.'&email='.$email->email}}
                </p>
            </div>
            <div style="margin-left:3%; width: 80%;">
                <p>
